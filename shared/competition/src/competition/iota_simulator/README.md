...
| -------------------------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `/route` response                | 0.5 seconds                       | Any single `/route` call that exceeds this fails the **entire task** with a score of 0. Your handler must be fast.                                                                                                                                                                   |
| `/balance-orchestrator` response | 0.5 seconds                       | Any single `/balance-orchestrator` call that exceeds this fails the **entire task** with a score of 0.                                                                                                                                                                               |
...
The `/route` timeout is the most important constraint: your routing logic must respond well under 0.5 seconds. Heavy computation risks timing out and zeroing the task.
